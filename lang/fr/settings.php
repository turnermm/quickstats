...
$lang['xcl_name_val']          = 'Liste séparée par des virgules des paires nom/valeur à l’intérieur des requêtes web qui devraient être exclues des statistiques';
...
$lang['xcl_pages']             = 'Liste à virgules de noms de page ou de catégories à exclure des statistiques. Pour les pages, utiliser le format <code>cat:nomdepage</code>. Pour les catégories, le format <code>cat::&nbsp;</code>. Dans les deux cas, indiquez le chemin de catégories complet : <code>cat1:cat2:</code>, etc… Ne pas utiliser de deux point Initiaux : <code>cat::</code> et non <code>:cat::</code>. Semblablement,  <code>nomdepage</code>, et non <code>:nomdepage</code>';
