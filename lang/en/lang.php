...
$lang['tar_extracted'] = 'Tar file extracted: %s.';
$lang['installing_mmdb'] = 'Installing .mmdb at %s.';
$lang['no_unpack'] = 'Unable to unpack %s. You may be able to do this using a zip tool on your system.';
$lang['clean_data_tmp'] = "Please check your data/tmp directory and remove data/tmp/tmp any Geocity files found in it\n";
$lang['no_geoip_local'] = 'When installing GeoLiteCity.dat in quickstats/GEOIP/, the "geoip_local" option must be set to true.';
$lang['click_to_view'] = 'Click to view file';
$lang['user_agent'] = 'UserAgent';
$lang['sel_user_agent'] = 'Select UserAgent';
$lang['country'] = 'Country';
$lang['sel_country'] = 'Select Country';
$lang['search_link'] = 'Search:';
$lang['year'] = 'Year:';
$lang['browsers'] = 'Browsers';
$lang['countries'] ='Countries';
$lang['platforms']='Platforms';
$lang['browsers_and_ua'] = 'Browsers and User Agents&nbsp;';
$lang['uniq_ip'] = 'Unique IP Addresses';
$lang['ttl_uniq_ip'] = 'Total unique ip addresses:&nbsp';
$lang['ttl_accesses_ua'] = 'Total Accesses for User Agents';
